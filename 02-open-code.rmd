...
- NHS England [Open Source Programme](https://www.england.nhs.uk/digitaltechnology/open-source/)[-@nhsx_osp] - a comprehensive description of why and how open source should be implemented in the NHS, including statements about best practice and a checklist for open sourcing code,
